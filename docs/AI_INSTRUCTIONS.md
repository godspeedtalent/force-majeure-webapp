...
This project uses a **monorepo architecture** with three packages:

- **`@force-majeure/shared`** (`packages/shared`) - Platform-agnostic code for both web and mobile
- **`@force-majeure/web`** (`packages/web`) - Web application (React + Vite)
- **`@force-majeure/mobile`** (`packages/mobile`) - Mobile app (React Native + Expo)

### Package Boundaries

- **Shared** can import: Nothing (only relative imports within shared)
- **Web** can import: `@force-majeure/shared` + web-specific dependencies
- **Mobile** can import: `@force-majeure/shared` + mobile-specific dependencies
- **Never**: Web and mobile should never import from each other

### Import Patterns by Package
...
// ❌ Never import from web or mobile
import { Button } from '@force-majeure/web'; // WRONG
```
...
// ✅ Import web-specific code with @ alias
import { Button } from '@/components/common/ui/Button';
import { Layout } from '@/components/layout/Layout';

// ❌ Never import from mobile
import { Screen } from '@force-majeure/mobile'; // WRONG
```
...
// ✅ Import mobile-specific code with @ alias
import { Button } from '@/components/Button';
import { HomeScreen } from '@/screens/HomeScreen';

// ❌ Never import from web
import { Layout } from '@force-majeure/web'; // WRONG
```
