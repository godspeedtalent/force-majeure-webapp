...
export const activityLogKeys = {
  ...
  list: (filters: ActivityLogFilters, page: number, pageSize: number) =>
    [...activityLogKeys.lists(), { filters, page, pageSize }] as const,
  ...
  summary: (dateFrom?: string, dateTo?: string) =>
    [...activityLogKeys.all, 'summary', { dateFrom, dateTo }] as const,
  resource: (resourceType: string, resourceId: string) =>
    [...activityLogKeys.all, 'resource', resourceType, resourceId] as const,
  user: (userId: string) =>
    [...activityLogKeys.all, 'user', userId] as const,
};
...
export function useActivityLogs(
  ...
  return useQuery<PaginatedActivityLogs, Error>({
 ...
 */
export function useActivitySummary(dateFrom?: string, dateTo?: string) {
  return useQuery<ActivityLogSummary[], Error>({
 ...
 */
export function useActivityLogById(
  id: string | undefined,
  options?: { enabled?: boolean }
) {
  return useQuery<ActivityLog | null, Error>({
...
export function useExportActivityLogs() {
  ...
  return useMutation<
    Blob,
    Error,
    { filters: ActivityLogFilters; format: 'json' | 'csv' }
  >({
