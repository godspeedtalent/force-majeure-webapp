...
function createMockQueryBuilder(returnValue: any, error: any = null) {
  ...
  mockBuilder.order = vi.fn().mockResolvedValue({ data: returnValue, error });
  mockBuilder.select = vi.fn().mockReturnValue({
    ...mockBuilder,
    eq: vi.fn().mockReturnValue({
      ...mockBuilder,
      eq: vi.fn().mockReturnValue({
        order: vi.fn().mockResolvedValue({ data: returnValue, error }),
        single: vi.fn().mockResolvedValue({ data: returnValue, error }),
      }),
      order: vi.fn().mockResolvedValue({ data: returnValue, error }),
      single: vi.fn().mockResolvedValue({ data: returnValue, error }),
