...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'focus:outline-none focus:border-b-[3px] focus:border-b-fm-gold focus:border-t-transparent focus:border-l-transparent focus:border-r-transparent',
      'focus:shadow-[0_4px_16px_rgba(223,186,125,0.3)]',
      // Open state
      'data-[state=open]:border-fm-gold/60 data-[state=open]:bg-white/5',
      'data-[state=open]:shadow-[0_0_16px_rgba(223,186,125,0.2)]',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'border border-white/20 border-l-[3px] border-l-fm-gold/60',
...
>(({ className, children, index = 0, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      // Bottom divider
      'after:absolute after:bottom-0 after:left-0 after:right-0 after:h-px after:bg-gradient-to-r after:from-transparent after:via-white/15 after:to-transparent',
      className
    )}
    {...props}
  >
