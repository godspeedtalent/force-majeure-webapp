-- ============================================================================
-- FIX: Make calculate_submission_score() SECURITY DEFINER
-- ============================================================================
-- Issue: The function queries screening_reviews table but is subject to RLS,
-- causing hangs when called from the trigger after review insert.
--
-- Fix: Add SECURITY DEFINER to bypass RLS when counting reviews.
-- ============================================================================
