-- ============================================================================
-- FIX SCREENING FUNCTION SCHEMA MISMATCH
-- ============================================================================
-- The get_submissions_with_details() function references columns that don't
-- exist in the actual artist_recordings table:
--   - duration_seconds (doesn't exist)
--
-- This migration fixes the function to use the correct schema.
-- ============================================================================
...
BEGIN
  SELECT jsonb_agg(
    jsonb_build_object(
      ...
      -- Recording details (minimal columns that definitely exist)
      ...
      -- Submission tags (with full tag details) - only if table exists
...
COMMENT ON FUNCTION get_submissions_with_details IS
  'Returns submissions with full details including artist genres, venue required genres, tags, reviews, and scores. Fixed to match actual artist_recordings schema.';
