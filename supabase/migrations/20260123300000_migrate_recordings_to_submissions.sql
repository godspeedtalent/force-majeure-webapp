-- ============================================================================
-- ONE-TIME MIGRATION: Artist Recordings to Screening Submissions
-- ============================================================================
-- Created: 2026-01-23
-- Purpose: Migrates all artist_recordings to screening_submissions
-- Creates universal "MIGRATED" tag and applies it to all migrated submissions
-- NOTE: This replaces the previous migration that looked for recording_type column
-- ============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    'Automatically migrated from existing artist recordings',
  ...
  -- Step 2: Migrate all artist recordings to submissions
  FOR v_recording IN
    SELECT
  ...
  -- Log results
  RAISE NOTICE 'Recording Migration Complete:';
  RAISE NOTICE '  - Migrated: % recordings', v_migrated_count;
