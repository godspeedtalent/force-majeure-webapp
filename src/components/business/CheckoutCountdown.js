...
export const CheckoutCountdown = ({ onExpire, redirectUrl, }) => {
    ...
    return (_jsxs("div", { className: 'flex items-center gap-2 font-canela', children: [_jsx(Clock, { className: 'h-4 w-4', style: { color: getTextColor() } }), _jsx("span", { className: 'text-sm font-medium transition-colors duration-1000', style: { color: getTextColor() }, children: formatTime(secondsRemaining) })] }));
};
