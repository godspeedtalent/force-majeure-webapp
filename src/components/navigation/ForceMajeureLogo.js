...
export const ForceMajeureLogo = ({ className = '', size = 'md', }) => {
    ...
    return (_jsx("div", { className: cn('relative', sizeClasses[size], aspectRatioClass, className), children: _jsx(ImageWithSkeleton, { src: logoSrc, alt: 'Force Majeure', className: 'object-contain w-full h-full', skeletonClassName: 'rounded-none' // Sharp corners per design system
         }) }));
};
