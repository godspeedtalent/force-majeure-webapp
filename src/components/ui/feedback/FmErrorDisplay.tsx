  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-background p-4'>
      <div className='max-w-2xl w-full text-center space-y-6'>
        <div className='space-y-2'>
          ...
          {isDeveloper ? (
            <p className='text-muted-foreground'>
              An error occurred in the application. Details are shown below for debugging.
            </p>
          ) : (
            <p className='text-muted-foreground'>
        ...
        {/* Error Message */}
        {error && (
          <FmInfoCard icon={AlertTriangle} title="Error Details" className="text-left">
              ...
              <div className="mt-4">
                ...
                {isStackTraceExpanded && (
                  <div className="mt-2 space-y-2">
                    <div className="p-3 bg-black/40 border border-border rounded-md max-h-64 overflow-auto">
        ...
        <div className='flex flex-col sm:flex-row gap-3 justify-center'>
          <Button onClick={handleReset} variant='default' className="bg-fm-gold hover:bg-fm-gold/90 text-black">
            Reload Page
          </Button>
