...
export function GlobalResourceSearch({ isOpen, onClose, }) {
    ...
    if (!isOpen)
        return null;
    return (_jsx("div", { className: 'fixed inset-0 z-[200] flex items-start justify-center pt-[15vh] px-4 bg-black/80 backdrop-blur-lg', onClick: handleOverlayClick, children: _jsx("div", { className: 'w-full max-w-2xl', children: _jsxs("div", { className: 'relative bg-background/95 backdrop-blur-xl border border-border rounded-none shadow-2xl', children: [_jsx("button", { onClick: onClose, className: 'absolute top-4 right-4 p-2 rounded-none hover:bg-muted transition-colors z-10', "aria-label": t('globalSearch.closeSearch'), children: _jsx(X, { className: 'h-5 w-5 text-muted-foreground' }) }), _jsxs("div", { className: 'relative p-6 border-b border-border', children: [_jsx(Search, { className: 'absolute left-9 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground' }), _jsx(Input, { ref: inputRef, type: 'text', placeholder: t('globalSearch.placeholder'), value: searchQuery, onChange: e => setSearchQuery(e.target.value), className: cn('text-lg border-0 focus-visible:ring-0 shadow-none bg-transparent pl-9 pr-4', searchQuery && 'border-b-2 border-b-gold-500') }), isSearching && (_jsx("div", { className: 'absolute right-4 top-1/2 -translate-y-1/2', children: _jsx("div", { className: 'h-5 w-5 border-2 border-fm-gold border-t-transparent rounded-full animate-spin' }) }))] }), searchQuery.trim().length >= 2 && (_jsx("div", { className: 'max-h-[60vh] overflow-y-auto p-2', children: isSearching ? (_jsx("div", { className: 'py-8 text-center text-muted-foreground', children: t('globalSearch.searching') })) : hasResults ? (_jsxs("div", { className: 'space-y-0', children: [results.organizations.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: 'px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10', children: t('globalSearch.sections.organizations') }), results.organizations.map(org => (_jsxs("button", { onClick: () => handleNavigate('organization', org.id), className: 'w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left', children: [_jsx("div", { className: 'flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center overflow-hidden', children: org.logo_url ? (_jsx("img", { src: org.logo_url, alt: org.name, className: 'w-full h-full object-cover' })) : (_jsx(Building2, { className: 'h-4 w-4 text-muted-foreground' })) }), _jsx("div", { className: 'flex-1 min-w-0', children: _jsx("p", { className: 'text-sm font-medium truncate', children: org.name }) })] }, org.id)))] })), results.users.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: 'px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10', children: t('globalSearch.sections.users') }), results.users.map(user => (_jsxs("button", { onClick: () => handleNavigate('user', user.id), className: 'w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left', children: [_jsx("div", { className: 'flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center overflow-hidden', children: user.avatar_url ? (_jsx("img", { src: user.avatar_url, alt: user.display_name || user.full_name || 'User', className: 'w-full h-full object-cover' })) : (_jsx(User, { className: 'h-4 w-4 text-muted-foreground' })) }), _jsxs("div", { className: 'flex-1 min-w-0', children: [_jsx("p", { className: 'text-sm font-medium truncate', children: user.display_name || user.full_name || t('globalSearch.unknownUser') }), user.email && (_jsx("p", { className: 'text-xs text-muted-foreground truncate', children: user.email }))] })] }, user.id)))] })), results.artists.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: 'px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10', children: t('globalSearch.sections.artists') }), results.artists.map(artist => (_jsxs("button", { onClick: () => handleNavigate('artist', artist.id), className: 'w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left', children: [_jsx("div", { className: 'flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center overflow-hidden', children: artist.image_url ? (_jsx("img", { src: artist.image_url, alt: artist.name, className: 'w-full h-full object-cover' })) : (_jsx(Music, { className: 'h-4 w-4 text-muted-foreground' })) }), _jsx("div", { className: 'flex-1 min-w-0', children: _jsx("p", { className: 'text-sm font-medium truncate', children: artist.name }) })] }, artist.id)))] })), results.venues.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: 'px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10', children: t('globalSearch.sections.venues') }), results.venues.map(venue => (_jsxs("button", { onClick: () => handleNavigate('venue', venue.id), className: 'w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left', children: [_jsx("div", { className: 'flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center overflow-hidden', children: venue.image_url ? (_jsx("img", { src: venue.image_url, alt: venue.name, className: 'w-full h-full object-cover' })) : (_jsx(MapPin, { className: 'h-4 w-4 text-muted-foreground' })) }), _jsx("div", { className: 'flex-1 min-w-0', children: _jsx("p", { className: 'text-sm font-medium truncate', children: venue.name }) })] }, venue.id)))] })), results.events.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: 'px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-white/10', children: t('globalSearch.sections.events') }), results.events.map(event => (_jsxs("button", { onClick: () => handleNavigate('event', event.id), className: 'w-full flex items-center gap-3 p-3 hover:bg-muted/50 transition-colors text-left', children: [_jsx("div", { className: 'flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center overflow-hidden', children: event.hero_image ? (_jsx("img", { src: event.hero_image, alt: event.title, className: 'w-full h-full object-cover' })) : (_jsx(Calendar, { className: 'h-4 w-4 text-muted-foreground' })) }), _jsxs("div", { className: 'flex-1 min-w-0', children: [_jsx("p", { className: 'text-sm font-medium truncate', children: event.title }), _jsxs("p", { className: 'text-xs text-muted-foreground truncate', children: [new Date(event.date).toLocaleDateString(), " \u2022", ' ', event.venue_name] })] })] }, event.id)))] }))] })) : (_jsx("div", { className: 'py-8 text-center text-muted-foreground', children: t('globalSearch.noResults', { query: searchQuery }) })) }))] }) }) }));
}
