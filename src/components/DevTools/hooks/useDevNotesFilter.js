...
import { NOTE_TYPE_CONFIG, NOTE_STATUS_INDICATOR_CONFIG, } from '../config/devNotesConfig';
/**
 * Hook to manage dev notes filtering logic
 * Handles search, type, status, and author filters
 */
export function useDevNotesFilter({ notes, sortField = 'created_at', sortOrder = 'desc', }) {
