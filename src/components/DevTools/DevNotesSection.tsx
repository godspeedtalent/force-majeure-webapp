  ...
  return (
    <div className='space-y-[12px]'>
      ...
      <div className='px-[20px] flex gap-[10px] items-center mb-4'>
        ...
        >
          <SelectTrigger className='h-12 w-[140px] bg-muted border-white rounded-none hover:border-fm-gold transition-colors text-xs'>
      ...
      <div className='px-[20px] text-xs text-muted-foreground mb-2'>
        Sorting by {SORT_FIELD_LABELS[sortField]} ({sortOrder === 'asc' ? 'ascending' : 'descending'})
      </div>
