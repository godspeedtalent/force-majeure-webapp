 ...
 */
export const TopographicBackground = ({ opacity = 0.015, className, parallax = true, parallaxSpeed = 0.5, }) => {
    ...
    return (_jsx("div", { className: cn('fixed inset-0 pointer-events-none overflow-hidden', className), style: { opacity }, children: _jsx("div", { className: 'absolute', style: {
            ...
            }, children: Array.from({ length: gridRows * gridCols }).map((_, superIndex) => {
                ...
                return (_jsx("div", { style: {
                    ...
                    }, children: [0, 1, 2].map(tileY => [0, 1, 2].map(tileX => {
                        const centerX = 1;
                        const centerY = 1;
