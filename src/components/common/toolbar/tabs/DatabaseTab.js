...
export function DatabaseTabFooter({ onNavigate }) {
    return (_jsx("div", { className: 'pb-4', children: _jsx(FmCommonButton, { variant: 'default', icon: Database, iconPosition: 'left', onClick: () => onNavigate('/developer/database'), className: 'w-full justify-start', children: "Go to Database Manager" }) }));
}
