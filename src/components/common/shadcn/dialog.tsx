...
>(({ className, children, ...props }, ref) => (
  <DialogPortal container={document.body}>
    ...
    >
      {children}
      <DialogPrimitive.Close className='absolute right-4 top-4 rounded-md opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-white/10 p-1.5 focus:outline-none focus:ring-2 focus:ring-fm-gold/50 focus:ring-offset-2 disabled:pointer-events-none'>
        <X className='h-4 w-4' />
