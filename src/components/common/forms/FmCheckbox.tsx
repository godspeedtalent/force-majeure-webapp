  ...
  return (
    <div
      className={cn(
        ...
        !disabled && 'hover:bg-white/5 hover:shadow-[0_0_16px_rgba(207,173,118,0.3)] cursor-pointer',
    ...
    >
      <Label
        ...
        className={cn(
          ...
          !disabled && 'cursor-pointer group-hover:text-fm-gold group-hover:translate-x-1',
      ...
      <Checkbox
        ...
        className={cn(
          ...
          !disabled && 'group-hover:border-fm-gold group-hover:shadow-[0_0_12px_rgba(207,173,118,0.5)] group-hover:scale-110',
