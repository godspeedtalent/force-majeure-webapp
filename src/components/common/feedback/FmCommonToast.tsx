...
const getToastStyles = () => {
  return {
    className:
      'group bg-black/80 backdrop-blur-md border border-white/20 text-white shadow-xl hover:border-fm-gold/50 hover:shadow-[0_0_16px_rgba(207,173,118,0.3)] hover:scale-[1.02] transition-all duration-300 cursor-pointer',
    ...
    <div
      ...
      onClick={e => {
        ...
        if (toastEl) {
          ...
          setTimeout(() => {
            sonnerToast.dismiss(
              toastEl.getAttribute('data-toast-id') || undefined
            );
          }, 300);
        }
      }}
