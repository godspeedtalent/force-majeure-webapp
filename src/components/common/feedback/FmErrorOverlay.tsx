      ...
      >
        ...
        <div className='flex-1 overflow-y-auto p-6 space-y-6'>
          ...
          <div className='space-y-2'>
            <FmI18nCommon
              i18nKey='errorOverlay.errorMessage'
              as='h3'
              className='text-sm font-semibold text-fm-gold uppercase tracking-wide'
            />
              ...
              <div className='space-y-2'>
                {context && (
                  <div className='flex gap-2'>
                    <FmI18nCommon
                      i18nKey='errorOverlay.contextLabel'
                      as='span'
          ...
          >
            {copied ? (
              ...
              <>
                ...
                <FmI18nCommon i18nKey='errorOverlay.copyDetails' />
              </>
            )}
          </Button>
          <Button
