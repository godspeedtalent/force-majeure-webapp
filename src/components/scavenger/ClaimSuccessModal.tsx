...
export const ClaimSuccessModal = ({
  ...
  const rewardDisplay = rewardType === 'free_ticket' ? '🎫 Free Ticket' : '🎟️ 20% Off';
      ...
      <DialogContent className="max-w-lg bg-background border-fm-gold">
        <div className="text-center py-8 px-4">
          ...
          <div className="relative mb-6">
            <div className={`inline-block p-6 bg-gradient-gold rounded-full ${confettiVisible ? 'animate-scale-in' : ''}`}>
          ...
          <p className="text-lg text-muted-foreground mb-2">
            You're the <span className="font-bold text-fm-gold">{getPositionText(claimPosition)}</span> person
          </p>
