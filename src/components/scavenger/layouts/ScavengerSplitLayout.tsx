  ...
  return (
    <>
      ...
      <div className='h-[calc(100vh-6.5rem)] flex flex-col lg:flex-row'>
        {/* Left Column - Content */}
        <div className='flex-1 lg:w-1/2 flex items-stretch justify-center lg:overflow-hidden relative z-10 lg:shadow-[8px_0_24px_-8px_rgba(0,0,0,0.3)] lg:border-r border-border'>
          <div className='absolute inset-0 bg-topographic opacity-20 lg:opacity-30 bg-no-repeat bg-cover bg-center backdrop-blur-sm' />
          <div className='w-full max-w-md px-4 py-6 lg:px-8 lg:py-12 relative z-10 flex items-center'>
            {children}
          </div>
        </div>
