    ...
    <MessagePanel
      ...
      action={
        <>
          ...
          <FmI18nCommon i18nKey='scavenger.checkpoint.getOnGuestlist' as='p' className='text-base text-muted-foreground' />
          <DecorativeDivider />
          <Button
            size='lg'
    ...
    <MessagePanel
      ...
      action={
        <>
          ...
          <FmI18nCommon i18nKey='scavenger.checkpoint.signUpPrompt' as='p' className='text-base text-muted-foreground mb-4' />
          <DecorativeDivider />
          <Button
            size='lg'
            className='w-full max-w-xs mx-auto bg-gradient-gold hover:opacity-90 font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]'
  ...
  return (
    <MessagePanel
      ...
      action={
        <>
          <DecorativeDivider />
          <FmI18nCommon i18nKey='scavenger.noCheckpoint.registerTitle' as='h2' className='font-display text-2xl md:text-3xl text-fm-gold' />
          <FmI18nCommon i18nKey='scavenger.noCheckpoint.registerDescription' as='p' className='text-base text-muted-foreground' />
          <Button
            size='lg'
            className='w-full max-w-xs mx-auto bg-gradient-gold hover:opacity-90 font-semibold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]'
            onClick={onJoinClick}
