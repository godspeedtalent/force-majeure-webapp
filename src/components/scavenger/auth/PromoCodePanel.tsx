...
export function PromoCodePanel({
  ...
  return (
    <MessagePanel
      ...
      action={
        <>
          <FmI18nCommon i18nKey='scavenger.promoCode.spotsClaimed' as='h1' className='font-display text-4xl md:text-5xl mb-4' />
          <FmI18nCommon i18nKey='scavenger.promoCode.spotsClaimedDescription' as='p' className='text-base text-muted-foreground mb-4' />
          <DecorativeDivider />
