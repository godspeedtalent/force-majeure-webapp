    ...
    <>
      <MessagePanel
        ...
        action={
          <>
            <DecorativeDivider />
            <FmI18nCommon i18nKey='scavenger.views.photoInstructions' as='p' className='text-muted-foreground font-canela' />
            ...
            <DecorativeDivider />
            <FmI18nCommon i18nKey='scavenger.views.jumpToTickets' as='p' className='text-white font-canela' />
            <Button
              size='lg'
