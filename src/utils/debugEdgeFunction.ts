...
export async function testEdgeFunctionConnectivity() {
    const baseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://orgxcrnnecblhuxjfruy.supabase.co';
    ...
    console.log('Environment check:', {
        VITE_SUPABASE_URL: import.meta.env.VITE_SUPABASE_URL || 'Not set (using fallback)',
