...
const createFadeAnimation = (direction, distance = '10px') => ({
...
const createAnimation = (name, duration, easing = 'ease-out', iteration = '') => `${name} ${duration} ${easing}${iteration ? ` ${iteration}` : ''}`;
export const animations = {
    ...
    'border-pulse-gold': createAnimation('border-pulse-gold', '0.6s', 'ease-in-out'),
    // Orb animations
