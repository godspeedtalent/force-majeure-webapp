  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-3 p-4 rounded-lg border border-border bg-muted/20">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            These settings control which sections appear in the dev toolbar at the bottom of the screen.
            Changes require a page refresh to take effect. The dev toolbar only appears in development mode.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        <span>Keyboard shortcut: Ctrl+Shift+D (Cmd+Shift+D on Mac) to toggle dev toolbar</span>
      </div>
    </div>
  );
};
