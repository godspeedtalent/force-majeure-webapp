 ...
 */
export async function refreshTableSchema(tableName) {
    try {
 ...
 */
export async function refreshAllTableSchemas() {
    try {
 ...
 */
export async function hasTableMetadata(tableName) {
    try {
 ...
 */
export async function getMissingMetadataTables() {
    try {
 ...
 */
export async function refreshMissingMetadata() {
    try {
        ...
        const results = await Promise.all(missing.map(tableName => refreshTableSchema(tableName)));
