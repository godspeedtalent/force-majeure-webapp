 ...
 */
export function detectTypeFromName(columnName) {
 ...
 */
export function isReadonlyColumn(metadata) {
    ...
    if (metadata.default) {
        ...
        if (defaultLower.includes('gen_random_uuid') ||
 ...
 */
export function isRequiredColumn(metadata) {
 ...
 */
export function mapColumn(metadata) {
    ...
    const readonly = nameDetection.readonly ||
 ...
 */
export function mapColumns(metadataArray) {
 ...
 */
export function isSortableType(_type) {
 ...
 */
export function isFilterableType(_type) {
 ...
 */
export function isEditableType(_type, readonly) {
    if (readonly) {
        return false;
    }
 ...
 */
export function getDefaultWidth(type, columnName) {
 ...
 */
export function isValidDataGridType(type) {
    if (!type)
        return false;
    const validTypes = [
        'text',
