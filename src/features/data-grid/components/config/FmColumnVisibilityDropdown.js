...
export function FmColumnVisibilityDropdown({ baseColumns, columnConfigs, onToggleVisibility, onResetConfiguration, onClearFiltersAndSort, }) {
    return (_jsxs(DropdownMenu, { children: [_jsx(DropdownMenuTrigger, { asChild: true, children: _jsxs(Button, { variant: 'outline', size: 'sm', className: 'gap-2', children: [_jsx(Settings2, { className: 'h-4 w-4' }), "Columns"] }) }), _jsxs(DropdownMenuContent, { align: 'end', className: 'w-64', children: [_jsx(DropdownMenuLabel, { children: "Toggle Columns" }), _jsx(DropdownMenuSeparator, {}), _jsx("div", { className: 'max-h-[400px] overflow-y-auto px-2 py-1 space-y-1', children: baseColumns.map(col => {
                        ...
                        }) }), _jsx(DropdownMenuSeparator, {}), _jsxs(Button, { variant: 'ghost', size: 'sm', onClick: onResetConfiguration, className: 'w-full justify-start text-xs', children: [_jsx(RotateCcw, { className: 'h-4 w-4 mr-2' }), "Reset to Default"] }), _jsxs(Button, { variant: 'ghost', size: 'sm', onClick: onClearFiltersAndSort, className: 'w-full justify-start text-xs', children: [_jsx(RotateCcw, { className: 'h-4 w-4 mr-2' }), "Clear Filters & Sort"] })] })] }));
}
