    ...
    >
      <div className='space-y-6'>
        ...
        {(status === 'idle' || status === 'stopped') && (
          <div className='p-6 bg-card border border-border rounded-none'>
            ...
            <div className='space-y-4'>
              {suite.testCases.map((testCase, index) => (
                <div
                  key={testCase.id}
                  className='p-4 bg-muted/50 rounded-none border border-border'
                >
            ...
            <div className='mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-none'>
        ...
        {/* Control Panel */}
        <div className='flex flex-wrap items-center gap-4 p-4 bg-card border border-border rounded-none'>
        ...
        {/* Keyboard Help Panel */}
        {showKeyboardHelp && (
          <div className='mt-4 p-4 bg-muted/50 rounded-none border border-border'>
