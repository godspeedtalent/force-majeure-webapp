...
import { getArtistGenres, getArtistWithGenres, addGenreToArtist, removeGenreFromArtist, setPrimaryGenre, updateArtistGenres, getArtistsByGenre, searchArtists, } from './artistService';
...
describe('artistService', () => {
    ...
    describe('getArtistGenres', () => {
        it('should fetch artist genres via RPC', async () => {
            ...
            vi.mocked(supabase.rpc).mockResolvedValue({ data: mockRpcData, error: null });
    ...
    describe('addGenreToArtist', () => {
        ...
        it('should unset existing primary before adding as primary', async () => {
            ...
            vi.mocked(supabase.from).mockImplementation(() => {
                ...
                return callCount === 1 ? updateMockBuilder : insertMockBuilder;
            });
    ...
    describe('updateArtistGenres', () => {
        ...
        it('should throw on insert error', async () => {
            ...
            await expect(updateArtistGenres('artist-1', [{ genreId: 'genre-1', isPrimary: true }])).rejects.toEqual(mockError);
        });
    });
