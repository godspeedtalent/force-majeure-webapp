 ...
 */
export async function getChildGenres(parentId) {
    try {
 ...
 */
export async function getGenreWithParent(id) {
    try {
 ...
 */
export async function getGenreWithChildren(id) {
    try {
 ...
 */
export async function getGenreHierarchy(genreId) {
    try {
 ...
 */
export async function getGenrePath(genreId) {
    try {
 ...
 */
export async function searchGenres(query, limit = 20) {
    try {
 ...
 * Create a new genre
 */
export async function createGenre(name, parentId = null) {
    try {
