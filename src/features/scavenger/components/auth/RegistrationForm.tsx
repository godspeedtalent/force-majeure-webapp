        ...
        <div className='space-y-3'>
          <div className='space-y-1'>
            <Label htmlFor='fullName' className='text-sm'>
              Full Name <span className='text-fm-gold'>*</span>
            </Label>
            <Input
              id='fullName'
              type='text'
          ...
          <div className='space-y-1'>
            <Label htmlFor='displayName' className='text-sm'>
              Display Name <span className='text-fm-gold'>*</span>
            </Label>
            <Input
              id='displayName'
              type='text'
          ...
          <div className='space-y-1'>
            <Label htmlFor='phoneNumber' className='text-sm'>
              Phone Number <span className='text-fm-gold'>*</span>
            </Label>
            <Input
              id='phoneNumber'
              type='tel'
          ...
          <div className='space-y-1'>
            <Label htmlFor='instagramHandle' className='text-sm'>
              Instagram Handle
            </Label>
            <Input
              id='instagramHandle'
