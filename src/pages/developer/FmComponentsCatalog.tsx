...
function ComponentSection({ name, description, caveats, children, defaultOpen = false, id }: ComponentSectionProps) {
...
function ComponentGroup({ title, children, defaultOpen = true, id }: ComponentGroupProps) {
  const [isOpen, setIsOpen] = useState(defaultOpen);
  ...
  const navigationGroups: FmCommonSideNavGroup<ComponentCategory>[] = [
    {
      ...
      icon: BookOpen,
      items: [
        { id: 'overview', label: 'Overview', icon: Info, description: 'Component system philosophy' },
        { id: 'relationships', label: 'Relationships', icon: Network, description: 'Component architecture' },
      ],
    },
    {
      label: 'Components',
      icon: LayoutGrid,
      items: [
        { id: 'buttons', label: 'Buttons', icon: MousePointerClick, description: 'Action buttons' },
        { id: 'common-display', label: 'Cards & Display', icon: Info, description: 'Cards, badges, stats' },
        { id: 'data', label: 'Data', icon: Table, description: 'Tables and lists' },
        { id: 'display', label: 'Display', icon: Eye, description: 'Avatars and photos' },
        { id: 'feedback', label: 'Feedback', icon: MessageSquare, description: 'Toasts and spinners' },
        { id: 'forms', label: 'Form Inputs', icon: FormInput, description: 'Input components' },
        { id: 'common-forms', label: 'Form System', icon: FormInput, description: 'Complete form system' },
        { id: 'common-layout', label: 'Layout', icon: Layout, description: 'Grids and stacks' },
        { id: 'modals', label: 'Modals', icon: Layout, description: 'Dialogs and modals' },
        { id: 'navigation', label: 'Navigation', icon: Navigation, description: 'Navigation components' },
        { id: 'search', label: 'Search', icon: Search, description: 'Search dropdowns' },
        { id: 'misc', label: 'Miscellaneous', icon: Sparkles, description: 'Utility components' },
      ],
    },
  ];
  ...
  const renderCategoryContent = () => {
    switch (activeCategory) {
            ...
            <div className="p-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-border shadow-xl">
              ...
              <div className="space-y-6 text-muted-foreground">
                ...
                <section>
                  ...
                  <p className="mb-3">
                    All components are part of the unified FmCommon component system and organized into logical categories (see sidebar):
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-4">
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      <strong className="text-foreground">Buttons</strong>
                      <p className="text-sm mt-1">Action buttons, creation buttons, navigation buttons</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      <strong className="text-foreground">Cards & Display</strong>
                      <p className="text-sm mt-1">Cards, badges, stats, headers, and structured information</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      <strong className="text-foreground">Data</strong>
                      <p className="text-sm mt-1">Tables, lists, tabs, and data display components</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                    ...
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      ...
                      <p className="text-sm mt-1">Individual input components with validation</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      <strong className="text-foreground">Form System</strong>
                      <p className="text-sm mt-1">Complete form system with react-hook-form and Zod</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                    ...
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      ...
                      <p className="text-sm mt-1">Dialogs, confirmations, and modal windows</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                    ...
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      ...
                      <p className="text-sm mt-1">Autocomplete search dropdowns for various entities</p>
                    </div>
                    <div className="p-4 bg-slate-900/50 rounded-lg border border-slate-700">
                      <strong className="text-foreground">Miscellaneous</strong>
                      <p className="text-sm mt-1">Backgrounds, promo codes, and utility components</p>
                    </div>
                  </div>
                </section>
      ...
      case 'buttons':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Button Components</h2>
            <p className="text-muted-foreground mb-6">
              Action buttons with ripple effects, loading states, and icon support. All buttons use shadcn/ui primitives as their base.
            </p>
            ...
            >
              <div className="space-y-4">
                <FmCommonNavigationButton to="/developer/demo">Go to Demo</FmCommonNavigationButton>
                <FmCommonNavigationButton to="/events" variant="default">View Events</FmCommonNavigationButton>
              </div>
            </ComponentSection>
          </div>
        );
      ...
      case 'forms':
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Form Input Components</h2>
            <p className="text-muted-foreground mb-6">
              Input components for forms with validation, labels, and error handling.
            </p>
            ...
            <ComponentGroup title="Selection Inputs" id="selection-inputs" defaultOpen>
              <ComponentSection
                name="FmCommonSelect"
            ...
            <ComponentGroup title="Date/Time Inputs" id="datetime-inputs" defaultOpen>
              <ComponentSection
      ...
      case 'search':
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Search Components</h2>
            <p className="text-muted-foreground mb-6">
              Autocomplete search dropdowns for various entities. All specialized components extend FmCommonSearchDropdown.
            </p>
            ...
            <ComponentGroup title="Specialized Search Dropdowns" id="specialized-search" defaultOpen>
              <ComponentSection
      ...
      case 'data':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Data Components</h2>
            <p className="text-muted-foreground mb-6">
              Components for displaying structured data, tables, lists, and tabs.
            </p>
            ...
            >
              <FmCommonCollapsibleSection title="Click to expand" defaultOpen={false}>
            ...
            <ComponentSection
              ...
              caveats={["Large component (859 lines)", "Technical debt: Should be split into smaller components"]}
            >
              <p className="text-sm text-muted-foreground">
                See implementation in actual admin pages like User Management or Event Management for full examples.
              </p>
            </ComponentSection>
          </div>
        );
      ...
      case 'display':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Display Components</h2>
            <p className="text-muted-foreground mb-6">
      ...
      case 'feedback':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Feedback Components</h2>
            <p className="text-muted-foreground mb-6">
              User feedback components for loading states, errors, and notifications.
            </p>
      ...
      case 'modals':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Modal Components</h2>
            <p className="text-muted-foreground mb-6">
              Dialog and modal components for user interactions and confirmations.
            </p>
      ...
      case 'navigation':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Navigation Components</h2>
            <p className="text-muted-foreground mb-6">
            ...
            >
              <div className="space-y-4">
                ...
                <FmCommonBackButton text="Custom Back" to="/developer/demo" variant="default" />
              </div>
            </ComponentSection>
            ...
            >
              <p className="text-sm text-muted-foreground">
                See this catalog page's sidebar for a live example of FmCommonSideNav in action.
              </p>
            </ComponentSection>
          </div>
        );
      ...
      case 'misc':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Miscellaneous Components</h2>
            <p className="text-muted-foreground mb-6">
              Utility components for backgrounds, promo codes, and OAuth dividers.
            </p>
            ...
            >
              <div className="relative h-48 overflow-hidden rounded-lg border border-border">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                  <p className="text-foreground font-semibold">Content over topographic background</p>
                </div>
              </div>
            </ComponentSection>
      ...
      case 'common-display':
        return (
          <div className="space-y-6">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Cards & Display Components</h2>
            <p className="text-muted-foreground mb-6">
              High-level display components for cards, badges, stats, and structured information.
            </p>

            <ComponentGroup title="Badge Components" id="badge-components" defaultOpen>
              <ComponentSection
                name="FmBadge"
            ...
            <ComponentGroup title="Display Components" id="display-components" defaultOpen>
              <ComponentSection
            ...
            <ComponentGroup title="Card Components" id="card-components" defaultOpen>
              <ComponentSection
            ...
            <ComponentGroup title="Page Components" id="page-components" defaultOpen>
              <ComponentSection
      ...
      case 'common-layout':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Layout Components</h2>
            <p className="text-muted-foreground mb-6">
              Layout components for organizing content with consistent spacing and responsive grids.
            </p>
            ...
            >
              <div className="space-y-6">
                <div>
                  <p className="text-sm text-muted-foreground mb-3">Default variant (frosted glass):</p>
                  <FmCommonGridLayout columns={{ default: 1, md: 2 }} gap="md">
                    <FmCommonCard variant="default" size="md">
                      ...
                      <p className="text-sm text-muted-foreground">
                        This card uses the classic frosted glass effect with gradient background.
                        Perfect for feature sections and highlighted content.
                      </p>
                    </FmCommonCard>
                    <FmCommonCard variant="default" size="md" onClick={() => console.log('Clicked!')}>
                      <div className="flex items-center gap-2 mb-2">
                        <User className="h-5 w-5 text-fm-gold" />
                        <h3 className="font-canela text-lg">Clickable Card</h3>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        This card is interactive with onClick handler.
                        Notice the enhanced hover scale effect.
                      </p>
                    </FmCommonCard>
                  </FmCommonGridLayout>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground mb-3">Outline variant (clean border):</p>
                  <FmCommonGridLayout columns={{ default: 1, md: 2 }} gap="md">
                    <FmCommonCard variant="outline" size="md">
                      <div className="flex items-center gap-2 mb-2">
                        <MapPin className="h-5 w-5 text-fm-gold" />
                        <h3 className="font-canela text-lg">Billing Information</h3>
                      </div>
                    ...
                    <FmCommonCard variant="outline" size="md" onClick={() => console.log('Outline clicked!')}>
                      <div className="flex items-center gap-2 mb-2">
                        <Tag className="h-5 w-5 text-fm-gold" />
                        <h3 className="font-canela text-lg">Interactive Outline</h3>
                      </div>
                      <p className="text-sm text-muted-foreground">
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-3">Size variants:</p>
                  <FmCommonStackLayout spacing="md">
                    <FmCommonCard variant="outline" size="sm">
                      <p className="text-sm">Small card (sm padding)</p>
                    </FmCommonCard>
                    <FmCommonCard variant="outline" size="md">
                      <p className="text-sm">Medium card (md padding - default)</p>
                    </FmCommonCard>
      ...
      case 'common-forms':
        return (
          <div className="space-y-4">
            <h2 className="text-2xl font-canela font-semibold text-fm-gold">FmCommon Form System</h2>
            <p className="text-muted-foreground mb-6">
              Complete form system with react-hook-form integration, Zod validation, and standardized layouts.
            </p>
