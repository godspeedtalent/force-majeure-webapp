/**
 * DocumentationViewerTab - Tab content for documentation viewer within DeveloperHome
 *
 * Browse and search generated documentation files.
 * Converted from standalone DeveloperDocumentation page to embedded tab content.
 */
...
export function DocumentationViewerTab() {
  ...
  return (
    <div className="space-y-[20px]">
      <FmFormSectionHeader
        title={formatHeader('Documentation viewer')}
        description="Browse and search generated documentation"
        icon={FileText}
      />

      <div className="grid grid-cols-12 gap-[20px] h-[calc(100vh-350px)] min-h-[500px]">
          ...
          {selectedDoc ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center p-[40px]">
              ...
              <p className="text-muted-foreground max-w-md">
                Choose from the list on the left to view generated documentation, architecture
