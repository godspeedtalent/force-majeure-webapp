...
const DOCUMENTATION_FILES: DocumentFile[] = [
  ...
  { name: 'Architecture Quick Reference', path: '/docs/ARCHITECTURE_QUICK_REFERENCE.md', category: 'Core' },
  { name: 'Design System', path: '/docs/DESIGN_SYSTEM.md', category: 'Design' },
  { name: 'Error Handling Guide', path: '/docs/ERROR_HANDLING_GUIDE.md', category: 'Development' },
  { name: 'Error Handling README', path: '/docs/ERROR_HANDLING_README.md', category: 'Development' },
  { name: 'Event Views Setup', path: '/docs/EVENT_VIEWS_SETUP.md', category: 'Features' },
  { name: 'Feature Flag Guide', path: '/docs/FEATURE_FLAG_GUIDE.md', category: 'Development' },
  { name: 'Google OAuth Setup', path: '/docs/GOOGLE_OAUTH_SETUP.md', category: 'Authentication' },
  { name: 'Image Upload Setup', path: '/docs/IMAGE_UPLOAD_SETUP.md', category: 'Features' },
  { name: 'Migration Checklist', path: '/docs/MIGRATION_CHECKLIST.md', category: 'Migration' },
  { name: 'Migration Examples', path: '/docs/MIGRATION_EXAMPLES.md', category: 'Migration' },
  { name: 'Migration Summary', path: '/docs/MIGRATION_SUMMARY.md', category: 'Migration' },
  { name: 'Permission Management Guide', path: '/docs/PERMISSION_MANAGEMENT_GUIDE.md', category: 'Authentication' },
  { name: 'Role Permission Quick Reference', path: '/docs/ROLE_PERMISSION_QUICK_REFERENCE.md', category: 'Authentication' },
];
        ...
        <div className="col-span-9 border border-border rounded-none bg-card">
          {selectedDoc ? (
            <>
              <div className="p-[20px] border-b border-border">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-canela font-semibold">{selectedDoc.name}</h2>
            ...
            <div className="flex flex-col items-center justify-center h-full text-center p-[40px]">
              ...
              <h3 className="text-xl font-canela font-semibold mb-[10px]">Select a document to view.</h3>
              <p className="text-muted-foreground max-w-md">
                Choose from the list on the left to view generated documentation, architecture guides, and setup instructions.
              </p>
            </div>
          )}
        </div>
