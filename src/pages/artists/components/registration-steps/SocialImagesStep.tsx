      ...
      <div className='flex-1 overflow-y-auto px-[5px] pr-[10px]'>
        <div className='flex justify-center items-start'>
          <div className='w-[85vw] sm:w-[80%] lg:w-[60%] space-y-[20px] bg-black/60 backdrop-blur-sm border border-white/10 p-[30px] sm:p-[40px]'>
            <div>
              <FmI18nCommon i18nKey='artistRegistration.socialImagesTitle' as='h2' className='font-canela text-3xl mb-[10px]' />
              <FmI18nCommon i18nKey='artistRegistration.socialImagesDescription' as='p' className='font-canela text-sm text-muted-foreground' />
            </div>
            ...
            <div className='space-y-[10px]'>
              <FmI18nCommon i18nKey='sections.profileImages' as='h3' className='font-canela text-lg' />
            ...
            {/* Social Links */}
            <div className='space-y-[10px]'>
              <FmI18nCommon i18nKey='sections.socialMedia' as='h3' className='font-canela text-lg' />
