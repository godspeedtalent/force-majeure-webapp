      ...
      <div className='flex-1 overflow-y-auto px-[5px] pr-[10px]'>
        <div className='flex justify-center items-start'>
          <div className='w-[85vw] sm:w-[80%] space-y-[20px] bg-black/60 backdrop-blur-sm border border-white/10 p-[30px] sm:p-[40px]'>
            <div>
              <FmI18nCommon i18nKey='artistRegistration.termsTitle' as='h2' className='font-canela text-3xl mb-[10px]' />
              <FmI18nCommon i18nKey='artistRegistration.termsDescription' as='p' className='font-canela text-sm text-muted-foreground' />
            </div>
            ...
            <div className='bg-black/40 backdrop-blur-sm border border-white/20 rounded-none p-[20px]'>
              <FmI18nCommon i18nKey='artistRegistration.artistTermsTitle' as='h3' className='font-canela text-base mb-[10px]' />
              <FmI18nCommon i18nKey='artistRegistration.artistTermsSubtitle' as='p' className='font-canela text-xs text-muted-foreground mb-[10px]' />
              <div
            ...
            <div className='space-y-[15px]'>
              <FmI18nCommon i18nKey='sections.profileSettings' as='h3' className='font-canela text-base' />
