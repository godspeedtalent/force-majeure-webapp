...
export function SocialImagesStep({ formData, onInputChange, onNext, onPrevious, }) {
    ...
    const [currentUploadConfig, setCurrentUploadConfig] = useState(null);
