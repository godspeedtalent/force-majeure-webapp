    ...
    if (!validationResult.valid) {
      return (
        <>
          ...
          <div className="lg:hidden h-[40vh] w-full bg-muted relative overflow-hidden">
            <div 
              ref={parallaxRef1}
          ...
          <div className="min-h-screen flex flex-col lg:flex-row">
            <div className="flex-1 lg:w-1/2 flex items-center justify-center lg:overflow-y-auto relative z-10 lg:shadow-[8px_0_24px_-8px_rgba(0,0,0,0.3)] lg:border-r border-border">
              ...
              <div className="w-full max-w-md px-4 -mt-16 pb-6 lg:px-8 lg:py-12 lg:mt-0 relative z-10">
                <MessagePanel 
                  title="Invalid Token"
