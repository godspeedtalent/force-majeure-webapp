      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-fm-gold/10 rounded-lg">
              <Code className="h-6 w-6 text-fm-gold" />
            </div>
            <h1 className="text-4xl font-canela font-bold">Developer Demos</h1>
          </div>
          <p className="text-lg text-muted-foreground">
            Test and explore application features in a controlled environment
          </p>
        </div>
