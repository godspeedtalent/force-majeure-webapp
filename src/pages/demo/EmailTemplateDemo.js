...
export default function EmailTemplateDemo() {
    return (_jsx(DemoLayout, { title: 'Email Template Demo', description: 'Preview and test order receipt email templates', icon: Mail, condensed: false, children: _jsx(EmailPreview, {}) }));
}
