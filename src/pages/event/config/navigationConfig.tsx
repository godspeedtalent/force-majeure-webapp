...
import { MobileBottomTab } from '@/components/mobile';
...
interface EventNavigationConfig {
  navigationGroups: FmCommonSideNavGroup<EventTab>[];
  mobileTabs: MobileBottomTab[];
}

export function getEventNavigationConfig(isAdmin: boolean, t: TFunction): EventNavigationConfig {
  ...
  const mobileTabs: MobileBottomTab[] = [
    ...
    ...(isAdmin ? [{ id: 'admin' as EventTab, label: t('eventNav.mobile.admin'), icon: Shield }] : []),
  ];
