...
const Auth = () => {
    ...
    return (_jsx(ForceMajeureRootLayout, { children: _jsx("div", { className: 'flex items-center justify-center min-h-full px-4 py-12', children: _jsx(AuthPanel, { onAuthSuccess: handleAuthSuccess }) }) }));
};
export default Auth;
