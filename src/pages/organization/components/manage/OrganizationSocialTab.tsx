 ...
 *
 * Social media tab for organization management - website and social links.
 * Matches the style of VenueSocialTab for consistency.
 */
...
interface OrganizationSocialTabProps {
  // Email & Website
  email: string;
...
export function OrganizationSocialTab({
  email,
  onEmailChange,
  website,
  onWebsiteChange,
  ...
  return (
    <div className='space-y-6'>
      ...
      <FmFormSection
        ...
        description={t('organizationManagement.socialMediaDescription', 'Add your organization\'s website and social media links so fans can find and follow you.')}
        icon={Share2}
      >
