...
export const GenresManagement = () => {
    ...
    const handleDeleteClick = (genreOrGenres) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const successMessage = genresToDelete.length === 1
