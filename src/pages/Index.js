...
const Index = () => {
    ...
    const handleFetchError = async (context, error) => {
        await logApiError({
            endpoint: 'page:Index',
            method: 'FETCH',
    ...
    return (_jsx(Layout, { enableScrollSnap: false, children: _jsx("div", { className: 'min-h-screen relative', children: isMobile ? (_jsx(IndexMobile, { upcomingEvents: upcomingEvents, pastEvents: pastEvents, loading: loading, showPastEvents: showPastEvents, setShowPastEvents: setShowPastEvents, heroRef: heroRef, eventsRef: eventsRef, activeSection: activeSection, scrollToSection: scrollToSection, contentReady: contentReady })) : (_jsx(IndexDesktop, { upcomingEvents: upcomingEvents, pastEvents: pastEvents, loading: loading, showPastEvents: showPastEvents, setShowPastEvents: setShowPastEvents, heroRef: heroRef, eventsRef: eventsRef, isSingleRow: isSingleRow, parallaxOffset: parallaxOffset, fadeOpacity: fadeOpacity, contentReady: contentReady })) }) }));
};
