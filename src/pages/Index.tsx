  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-16 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
          <div className="text-center animate-fade-in">
            <Badge variant="outline" className="mb-6 border-fm-gold text-fm-gold hover:bg-fm-gold hover:text-black transition-colors duration-300">
              Promotions & A&R
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-fm-gold text-black hover:bg-fm-gold/90 shadow-gold group">
                <Calendar className="w-5 h-5 mr-2" />
                View Events
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" className="border-fm-crimson text-fm-crimson hover:bg-fm-crimson hover:text-white">
                Join Community
              </Button>
            </div>
          </div>
      ...
      <section id="contact" className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button size="lg" className="bg-fm-crimson text-white hover:bg-fm-crimson/90 shadow-crimson">
            Start Conversation
          </Button>
        </div>
      </section>
