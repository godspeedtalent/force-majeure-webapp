...
export const generateOrderReceiptEmailHTML = (data) => {
 ...
 */
export const OrderReceiptEmail = ({ data }) => {
    const html = generateOrderReceiptEmailHTML(data);
    return (_jsx("div", { dangerouslySetInnerHTML: { __html: html }, style: { width: '100%', height: '100%' } }));
};
