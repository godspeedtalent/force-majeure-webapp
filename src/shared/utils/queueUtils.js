 ...
 */
export function calculateEstimatedWaitTime(queuePosition, activeCount, maxConcurrent, avgSessionMinutes = 5) {
 ...
 */
export function getQueueProgressPercentage(position, total) {
    if (total === 0)
        return 100;
    if (position === 0)
        return 100;
 ...
 */
export function shouldNotifyPositionChange(oldPosition, newPosition) {
