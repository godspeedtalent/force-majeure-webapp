 ...
 */
import { SPACING_CLASSES, DEPTH, INPUT_STYLES, LABEL_STYLES, LIST_ITEM_STYLES, COLOR_CLASSES, BORDER_RADIUS, TYPOGRAPHY, } from '@/shared';
 ...
 * ```
 */
export function getListItemClasses(index, customClasses) {
 ...
 * ```
 */
export function getInputClasses(customClasses) {
    return cn('border border-input', INPUT_STYLES.BG_DEFAULT, INPUT_STYLES.HOVER_CLASSES, INPUT_STYLES.FOCUS_CLASSES, INPUT_STYLES.TRANSITION, BORDER_RADIUS.SHARP, TYPOGRAPHY.FONT_CANELA, customClasses);
}
/**
 ...
 * ```
 */
export function getLabelClasses(focused = false, customClasses) {
    return cn(focused ? LABEL_STYLES.FOCUSED_CLASSES : LABEL_STYLES.DEFAULT_CLASSES, LABEL_STYLES.TRANSITION, customClasses);
}
/**
 ...
 * ```
 */
export function getDepthClasses(level, customClasses) {
    const depthMap = {
 ...
 * ```
 */
export function getButtonClasses(variant = 'primary', customClasses) {
    const variants = {
    ...
    return cn(BORDER_RADIUS.SHARP, 'transition-all duration-300', SPACING_CLASSES.P_SM, TYPOGRAPHY.FONT_CANELA, variants[variant], customClasses);
}
/**
 ...
 * ```
 */
export function formatHeader(text, addPeriod = true) {
    if (!text)
        return text;
 ...
 * ```
 */
export function getCardClasses(variant = 'frosted', customClasses) {
    const variantMap = {
    ...
    return cn(variantMap[variant], BORDER_RADIUS.SHARP, SPACING_CLASSES.P_MD, customClasses);
}
/**
 ...
 * ```
 */
export function getIconButtonClasses(customClasses) {
    return cn('p-[5px]', BORDER_RADIUS.SHARP, COLOR_CLASSES.WHITE_TEXT, COLOR_CLASSES.GOLD_HOVER_TEXT, 'transition-colors duration-200', customClasses);
}
/**
...
export const GLASS_STYLES = {
     ...
     */
    PANEL: cn('bg-black/70 backdrop-blur-md', 'border-2 border-white/20', 'shadow-xl shadow-black/50'),
    /**
     * Modal overlay glass
     ...
     */
    DROPDOWN: cn('bg-gradient-to-r from-background to-background/95', 'backdrop-blur-xl', 'border-2 border-white/20', 'shadow-xl shadow-black/50'),
};
/**
...
export const GOLD_ACCENT_STYLES = {
     ...
     */
    BORDER_GLOW: cn(COLOR_CLASSES.GOLD_BORDER, 'shadow-[0_0_12px_rgba(223,186,125,0.3)]'),
    /**
     * Hover state - gold background
     */
    HOVER_BG: cn(COLOR_CLASSES.GOLD_HOVER_BG, 'transition-colors duration-300'),
    /**
     * Hover state - gold text
     */
    HOVER_TEXT: cn(COLOR_CLASSES.GOLD_HOVER_TEXT, 'transition-colors duration-300'),
    /**
     * Hover state - gold border with glow
     */
    HOVER_BORDER_GLOW: cn('hover:border-fm-gold/50', 'hover:shadow-[0_0_12px_rgba(223,186,125,0.15)]', 'transition-all duration-300'),
    /**
     * Focus state - gold border with strong glow
     */
    FOCUS_BORDER_GLOW: cn('focus-visible:border-fm-gold', 'focus-visible:shadow-[0_4px_16px_rgba(223,186,125,0.3)]', 'focus-visible:outline-none', 'transition-all duration-300'),
    /**
     ...
     */
    INTERACTIVE_OVERLAY: cn('hover:bg-fm-gold/10', 'focus:bg-fm-gold/15', 'active:opacity-90', 'transition-all duration-300'),
    /**
     * Gold divider line
     */
     ...
     */
    HOVER_UNDERLINE: cn('hover:border-b hover:border-fm-gold', 'transition-all duration-300'),
    /**
