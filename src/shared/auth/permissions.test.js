...
describe('ROLE_PERMISSIONS', () => {
    ...
    describe('DEVELOPER role', () => {
        it('has development-specific permissions', () => {
            expect(ROLE_PERMISSIONS[ROLES.DEVELOPER]).toContain(PERMISSIONS.ACCESS_DEV_TOOLS);
            expect(ROLE_PERMISSIONS[ROLES.DEVELOPER]).toContain(PERMISSIONS.ACCESS_DEMO_PAGES);
        });
        it('has wildcard permission', () => {
    ...
    describe('ORG_ADMIN role', () => {
        ...
        it('does not have wildcard permission', () => {
            expect(ROLE_PERMISSIONS[ROLES.ORG_ADMIN]).not.toContain(PERMISSIONS.ALL);
        });
...
describe('TypeScript types', () => {
    it('Permission type includes all permission values', () => {
        const testPermission = PERMISSIONS.MANAGE_USERS;
