import { ROLES, PERMISSIONS, type Role, type Permission } from '@/shared/auth/permissions';
 ...
 */
export const isValidPermissionName = (permissionName: unknown): permissionName is Permission => {
