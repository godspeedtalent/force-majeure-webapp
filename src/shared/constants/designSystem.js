...
export const LIST_ITEM_STYLES = {
    ...
    EVEN_CLASSES: 'bg-white/5 hover:bg-fm-gold/10 hover:scale-[1.02] hover:shadow-lg hover:shadow-fm-gold/20 hover:text-white focus:bg-fm-gold/15 focus:scale-[1.02] focus:shadow-lg focus:shadow-fm-gold/20 focus:text-white active:scale-[0.98] transition-all duration-300',
    // Complete Classes for Odd Items
    ODD_CLASSES: 'bg-black/30 hover:bg-fm-gold/10 hover:scale-[1.02] hover:shadow-lg hover:shadow-fm-gold/20 hover:text-white focus:bg-fm-gold/15 focus:scale-[1.02] focus:shadow-lg focus:shadow-fm-gold/20 focus:text-white active:scale-[0.98] transition-all duration-300',
