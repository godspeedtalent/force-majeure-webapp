...
describe('RoleManagementService', () => {
    ...
    describe('addRole', () => {
        ...
        it('should throw when role not found', async () => {
            ...
            vi.mocked(supabase.from).mockReturnValue(roleQueryBuilder);
            await expect(RoleManagementService.addRole('user-123', 'nonexistent')).rejects.toThrow('Role "nonexistent" not found');
        });
        it('should throw on database error when fetching role', async () => {
            ...
            vi.mocked(supabase.from).mockReturnValue(roleQueryBuilder);
            await expect(RoleManagementService.addRole('user-123', 'admin')).rejects.toEqual(mockError);
        ...
        it('should throw on database error when inserting user_role', async () => {
            ...
            await expect(RoleManagementService.addRole('user-123', 'admin')).rejects.toEqual(mockInsertError);
        });
    });
    describe('removeRole', () => {
        ...
        it('should throw when role not found', async () => {
            ...
            vi.mocked(supabase.from).mockReturnValue(roleQueryBuilder);
            await expect(RoleManagementService.removeRole('user-123', 'nonexistent')).rejects.toThrow('Role "nonexistent" not found');
        });
        it('should throw on database error when deleting', async () => {
            ...
            await expect(RoleManagementService.removeRole('user-123', 'admin')).rejects.toEqual(mockDeleteError);
        });
    });
    describe('hasRole', () => {
