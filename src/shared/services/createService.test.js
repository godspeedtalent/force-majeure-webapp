...
describe('createFilteredQuery', () => {
    ...
    it('should create query with eq filter', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { status: 'active' }, { status: { column: 'status', operator: 'eq' } });
        expect(mockBuilder.eq).toHaveBeenCalledWith('status', 'active');
    });
    it('should create query with gte filter', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { minValue: 100 }, { minValue: { column: 'value', operator: 'gte' } });
    ...
    it('should create query with lte filter', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { maxValue: 500 }, { maxValue: { column: 'value', operator: 'lte' } });
    ...
    it('should create query with ilike filter', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { searchName: '%test%' }, { searchName: { column: 'name', operator: 'ilike' } });
    ...
    it('should skip undefined and null filter values', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { status: 'active', category: undefined, type: null }, {
    ...
    it('should skip filters without mappings', () => {
        ...
        vi.mocked(supabase.from).mockReturnValue(mockBuilder);
        createFilteredQuery('test_table', '*', { unmapped: 'value' }, {});
