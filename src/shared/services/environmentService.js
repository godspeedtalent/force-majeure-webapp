...
class EnvironmentService {
    ...
    async getAvailableEnvironments() {
        ...
        try {
            ...
            envLogger.debug('Available environments loaded:', this.availableEnvironments.map(e => e.name));
            return this.availableEnvironments;
        }
        catch (error) {
...
export const getCurrentEnvironmentName = () => environmentService.getCurrentEnvironmentName();
export const getCurrentEnvironment = () => environmentService.getCurrentEnvironment();
export const getAvailableEnvironments = () => environmentService.getAvailableEnvironments();
