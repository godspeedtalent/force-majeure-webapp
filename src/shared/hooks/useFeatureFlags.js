...
import { getEnvironmentOverride, isDevelopment, } from '@/shared';
import { logger } from '@/shared';
import { environmentService } from '@/shared';
import { FEATURE_FLAGS, createEmptyFeatureFlagsState, } from '@/shared';
...
export const useFeatureFlags = () => {
    return useQuery({
        ...
        `)
            ...
            const flags = createEmptyFeatureFlagsState();
            data?.forEach(flag => {
...
export const useFeatureFlagHelpers = () => {
     ...
     */
    const isAnyFeatureEnabled = (...flagList) => {
     ...
     */
    const areAllFeaturesEnabled = (...flagList) => {
