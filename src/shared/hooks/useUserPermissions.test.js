...
describe('useUserPermissions', () => {
    ...
    describe('hasAnyPermission', () => {
        it('should return true when user has at least one permission', async () => {
            ...
            expect(result.current.hasAnyPermission(PERMISSIONS.MANAGE_ORGANIZATION, PERMISSIONS.SCAN_TICKETS)).toBe(true);
        });
        it('should return false when user has none of the permissions', async () => {
            ...
            expect(result.current.hasAnyPermission(PERMISSIONS.MANAGE_ORGANIZATION, PERMISSIONS.SCAN_TICKETS)).toBe(false);
        });
    });
    describe('hasAllPermissions', () => {
        it('should return true when user has all permissions', async () => {
            ...
            expect(result.current.hasAllPermissions(PERMISSIONS.MANAGE_ORGANIZATION, PERMISSIONS.VIEW_ORGANIZATION)).toBe(true);
        });
        it('should return false when user lacks one permission', async () => {
            ...
            expect(result.current.hasAllPermissions(PERMISSIONS.MANAGE_ORGANIZATION, PERMISSIONS.VIEW_ORGANIZATION)).toBe(false);
        });
    });
    describe('hasRole', () => {
