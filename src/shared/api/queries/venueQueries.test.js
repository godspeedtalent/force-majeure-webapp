...
import { useVenueById, useVenues, useVenuesWithFilters, useSearchVenues, useVenueCapacity, useVenueEventCount, useVenueHasEvents, useVenueCities, useVenuesByCity, useCreateVenue, useUpdateVenue, useDeleteVenue, venueKeys, } from './venueQueries';
// Mock venueService
...
describe('venueQueries', () => {
    ...
    describe('useVenueById', () => {
        it('should fetch venue by ID', async () => {
            ...
            vi.mocked(venueService.getVenueById).mockResolvedValue(mockVenue);
    ...
    describe('useVenues', () => {
        it('should fetch all venues', async () => {
            ...
            vi.mocked(venueService.getVenues).mockResolvedValue(mockVenues);
    ...
    describe('useVenuesWithFilters', () => {
        it('should fetch venues with filters', async () => {
            ...
            vi.mocked(venueService.getVenuesWithFilters).mockResolvedValue(mockVenues);
    ...
    describe('useSearchVenues', () => {
        it('should search venues when query is not empty', async () => {
            ...
            vi.mocked(venueService.searchVenues).mockResolvedValue(mockVenues);
    ...
    describe('useVenuesByCity', () => {
        it('should fetch venues by city', async () => {
            const mockVenues = [{ id: '1', name: 'Chicago Venue', city: 'Chicago' }];
            vi.mocked(venueService.getVenuesByCity).mockResolvedValue(mockVenues);
    ...
    describe('useCreateVenue', () => {
        it('should create venue and invalidate queries', async () => {
            ...
            vi.mocked(venueService.createVenue).mockResolvedValue(mockResult);
    ...
    describe('useUpdateVenue', () => {
        it('should update venue and invalidate queries', async () => {
            ...
            vi.mocked(venueService.updateVenue).mockResolvedValue(mockResult);
            const { wrapper, queryClient } = createWrapperWithClient();
            const invalidateSpy = vi.spyOn(queryClient, 'invalidateQueries');
    ...
    describe('error handling', () => {
        ...
        it('should handle mutation errors', async () => {
            ...
            await expect(result.current.mutateAsync({ name: 'Test', address_line_1: '123', city: 'City' })).rejects.toThrow('Create failed');
        });
    });
});
